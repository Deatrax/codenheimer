#ifndef SNIPPETJAVA_H
#define SNIPPETJAVA_H
...
class KeywordHighlighterJAVA : public QSyntaxHighlighter {
public:
    KeywordHighlighterJAVA(QTextDocument *parent = nullptr) : QSyntaxHighlighter(parent) {
...
class snippetJAVA : public snippetLiveClass
{
    private:
    KeywordHighlighterJAVA *highlighter;
public:
    snippetJAVA();
